...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "Google GData Documentation" /productName "Google GData Documentation"
...
"%SYSTEMDRIVE%\Program Files\Microsoft Help Viewer\v2.0\HlpCtntMgr.exe" /operation uninstall /catalogName VisualStudio11 /locale en-us /vendor "Vendor Name"  /productName "Google GData Documentation" /bookList "Google GData Documentation"

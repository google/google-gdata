...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "Google GData Documentation" /productName "Google GData Documentation" > NUL
...
IF EXIST "Google.GData.Documentation.msha" COPY /Y "Google.GData.Documentation.msha" HelpContentSetup.msha
...
"%SYSTEMDRIVE%\Program Files\Microsoft Help Viewer\v2.0\HlpCtntMgr.exe" /operation install /catalogName VisualStudio11 /locale en-us /sourceUri "%CD%\Google.GData.Documentation.msha"

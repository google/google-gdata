...
namespace Google.GData.Client.UnitTests.YouTube
{
    ...
    /// <summary>
    ///This is a test class for HomeTownTest and is intended
    ///to contain all HomeTownTest Unit Tests
    ///</summary>
    [TestFixture]
[Category("YouTube")]
    ...
    public class HomeTownTest
    {
        ...
        /// <summary>
        ///A test for HomeTown Constructor
        ///</summary>
        [Test]
        public void HomeTownConstructorTest1()
        {
            HomeTown target = new HomeTown();
        ...
        ///</summary>
        [Test]
        public void HomeTownConstructorTest()
        {
            string initValue = "secret test string";
            HomeTown target = new HomeTown(initValue);

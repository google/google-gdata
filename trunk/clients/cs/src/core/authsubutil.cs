    ...
    public class AuthSubUtil
    {
           ...
           if (response != null)
            {
                ...
                {
                    throw new GDataRequestException("Execution of exchangeForSessionToken request returned unexpected content type: " + response.ContentType,  response); 
                }
                                                    ...
                                                    string requestMethod)
       {
            ...
            else
            {
                ...
                return String.Format("AuthSub token=\"{0}\" data=\"{1}\" sig=\"{2}\" sigalg=\"{3}\"",

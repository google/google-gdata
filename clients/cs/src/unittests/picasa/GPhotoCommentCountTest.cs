...
namespace Google.GData.Client.UnitTests.Picasa
{
    ...
    /// <summary>
    ///This is a test class for GPhotoCommentCountTest and is intended
    ///to contain all GPhotoCommentCountTest Unit Tests
    ///</summary>
    [TestFixture][Category("Picasa")]
    public class GPhotoCommentCountTest
    {
        ...
        /// <summary>
        ///A test for GPhotoCommentCount Constructor
        ///</summary>
        [Test]

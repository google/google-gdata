...
namespace Google.GData.Client.UnitTests.YouTube
{
    ...
    /// <summary>
    ///This is a test class for UserNameTest and is intended
    ///to contain all UserNameTest Unit Tests
    ///</summary>
    [TestFixture]
[Category("YouTube")]
    ...
    public class UserNameTest
    {
        ...
        /// <summary>
        ///A test for UserName Constructor
        ///</summary>
        [Test]
        public void UserNameConstructorTest1()
        {
        ...
        ///</summary>
        [Test]
        public void UserNameConstructorTest()
        {
            string initValue = "secret test string";
            UserName target = new UserName(initValue);
